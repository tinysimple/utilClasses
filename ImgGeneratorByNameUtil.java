 ...
 * 根据姓名创建图片
 */
public class ImgGeneratorByNameUtil {

    public static void main(String[] args) throws IOException {
        String name = "测试";
        generateImg(name, "D:\\imgTemp", name); //第一个参数为要进行转换的字符串，第二个参数表示生成jpg文件所在的目录，第三个参数为jpg文件的名称
    }
    ...
    public static void generateImg(String name, String outputPath, String outputName)
        ...
        System.out.println("最终的文件路径以及文件名："+filename);
